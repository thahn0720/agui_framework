...
package agui.support.v4.internal.view;
 ...
 * @hide
 */
public interface SupportMenuItem extends thahn.java.agui.view.MenuItem {
    /*
    ...
    */
     ...
     * provider set via {@link #setSupportActionProvider(agui.support.v4.view.ActionProvider)}. </p>
     *
    ...
    /**
     * Sets the {@link agui.support.v4.view.ActionProvider} responsible for creating an action view if
     ...
     * @return This Item so additional setters can be called.
     * @see agui.support.v4.view.ActionProvider
     */
...
//    public ActionProvider getSupportActionProvider();
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(agui.support.v4.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link agui.support.v4.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(agui.support.v4.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link agui.support.v4.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
     ...
     * @see agui.support.v4.view.MenuItemCompat.OnActionExpandListener
     */
    public boolean isActionViewExpanded();

    /**
     * Set an {@link agui.support.v4.view.MenuItemCompat.OnActionExpandListener} on this menu item to be notified when the associated
