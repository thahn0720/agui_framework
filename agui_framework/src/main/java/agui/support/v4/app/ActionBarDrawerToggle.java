...
import thahn.java.agui.os.Build;
import thahn.java.agui.view.MenuItem;
import thahn.java.agui.view.View;
import agui.support.v4.graphics.drawable.DrawableCompat;
...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public static final int ID_HOME = thahn.java.agui.R.id.title; 
//    								thahn.java.agui.R.id.agui_drawer_home;//0x0102002c;
    ...
    private class SlideDrawable extends ImageDrawable {//MultipleDrawable {//LevelListDrawable implements Drawable.Callback {
        ...
        private SlideDrawable(Drawable wrapped) {
        	super();
        	mImages = (BufferedImage) wrapped.getImage();
...
//            canvas.save();
            ...
            final boolean isLayoutRTL = false;//ViewCompat.getLayoutDirection(
//                    mActivity.getWindow().getDecorView()) == ViewCompat.LAYOUT_DIRECTION_RTL;
            ...
            canvas.translate((int)(-mOffset * width * mPosition * flipRtl), 0);
