...
public class TextDirectionHeuristicsCompat {
     ...
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat LTR =
            new TextDirectionHeuristicInternal(null /* no algorithm */, false);

    /**
     * Always decides that the direction is right to left.
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat RTL =
     ...
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat FIRSTSTRONG_LTR =
     ...
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat FIRSTSTRONG_RTL =
     ...
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat ANYRTL_LTR =
            new TextDirectionHeuristicInternal(AnyStrong.INSTANCE_RTL, false);

    /**
     * Force the paragraph direction to the Locale direction. Falls back to left to right.
     */
    public static final agui.support.v4.text.TextDirectionHeuristicCompat LOCALE =
