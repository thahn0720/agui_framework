...
//        return !((absGravity & checkFor) == checkFor);
    ...
    /*package*/ void moveDrawerToOffset(View drawerView, float slideOffset) {
     ...
     */
    /*package*/ View findDrawerWithGravity(int gravity) {
...
//        }
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isContentView(child)) {
                child.onLayout(true, lp.leftMargin,
                        lp.topMargin,
                ...
                switch (vgrav) {
                    default:
                    case Gravity.TOP: {
                        child.onLayout(true, childLeft, lp.topMargin,
                    ...
                    case Gravity.CENTER_VERTICAL: {
                        ...
                        child.onLayout(true, childLeft, childTop,
...
//        canvas.restoreToCount(restoreCount);
        ...
        if (mScrimOpacity > 0 && drawingContent) {
            ...
            canvas.setColor(Color.toAwtColor(color));
//            mScrimPaint.setColor(color);
    ...
    /*package*/ void cancelChildViewTouch() {
        // Cancel child touches
        if (!mChildrenCanceledTouch) {
            final long now = System.currentTimeMillis();//uptimeMillis();
...
//            final TypedArray a = c.obtainStyledAttributes(attrs, LAYOUT_ATTRS);
            this.gravity = attrs.getIntFromEnum(thahn.java.agui.R.attr.View_layout_gravity, Gravity.NO_GRAVITY); 
//            		attrs.getInt(thahn.java.agui.R.attr.View_layout_gravity, Gravity.NO_GRAVITY);
//            a.recycle();
        }
