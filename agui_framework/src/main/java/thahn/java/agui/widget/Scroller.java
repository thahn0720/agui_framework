...
import thahn.java.agui.content.SensorManager;
import thahn.java.agui.graphics.FloatMath;
...
public class Scroller  {
    ...
    private float mFlingFriction = SCROLL_FRICTION;//ViewConfiguration.getScrollFriction();
...
//                context.getApplicationInfo().targetSdkVersion >= Build.VERSION_CODES.HONEYCOMB
    ...
    public Scroller(Context context, Interpolator interpolator, boolean flywheel) {
        ...
        mPpi = 1.0f//context.getResources().getDisplayMetrics().density
        		* 160.0f;
        mDeceleration = computeDeceleration(SCROLL_FRICTION);//ViewConfiguration.getScrollFriction());
        mFlywheel = flywheel;
