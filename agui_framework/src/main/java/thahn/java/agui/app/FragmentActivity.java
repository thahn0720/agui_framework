...
import agui.support.v4.util.SimpleArrayMap;

/**
 * Base class for activities that want to use the support-based
 * {@link thahn.java.agui.app.Fragment} and
 * {@link agui.support.v4.content.Loader} APIs.
 *
 ...
 * so allows you to use {@link thahn.java.agui.app.Fragment} APIs on API level 7 and higher.</p>
 *
...
public class FragmentActivity extends Activity {
    ...
    public static class FragmentTag {
        ...
        public static final int Fragment_id = thahn.java.agui.R.attr.View_id;//1;
        public static final int Fragment_name = 0;
        public static final int Fragment_tag = thahn.java.agui.R.attr.View_tag;//2;
    }
