...
public final class ComponentName implements Cloneable, Comparable<ComponentName>, Serializable {
	
	private static final long 											serialVersionUID = 2944035267622482487L;
    ...
    public ComponentName(Context pkg, String cls) {
        if (cls == null) throw new NullPointerException("class name is null");
        mPackage = Global.projectPackageName;//pkg.getPackageName();
        mClass = cls;
    }
