...
import thahn.java.agui.content.ComponentCallbacks;
...
//        dest.writeBundle(mSavedFragmentState);
    ...
    public static final Parcelable.Creator<FragmentState> CREATOR
        ...
        public FragmentState createFromParcel(Parcel in) {
            return null;//new FragmentState(in);
        }
...
/**
 * Static library support version of the framework's {@link thahn.java.agui.app.Fragment}.
 * Used to write apps that run on platforms prior to Android 3.0.  When running
 * on Android 3.0 or above, this implementation is still used; it does not try
 * to switch to the framework's implementation. See the framework {@link thahn.java.agui.app.Fragment}
