...
//    public abstract void setBackgroundColor(int color);
    public abstract void setMaximizeDrawable(Drawable d);
    public abstract void setMinimizeDrawable(Drawable d);
    public abstract void setExitDrawable(Drawable d);
    public abstract void setMaximizeVisible(int visible);
    public abstract void setMinimizeVisible(int visible);
    public abstract void setExitVisible(int visible);
