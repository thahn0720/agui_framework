...
import thahn.java.agui.widget.Adapter;
...
//    };
	...
	public void setContentView(int layoutId) {
		...
		if(mPanel.mDecorView instanceof ViewGroup) {
			View view = findViewById(thahn.java.agui.R.id.list);//findListView((ViewGroup) mPanel.mDecorView);
			if(view == null) throw new WrongFormatException("not contain ListView's agui:id=\"@+id/@agui:list\" in layout");
			mList = (ListView) view;
			mList.setOnItemClickListener(mOnItemClickListener);
		} else {
			throw new WrongFormatException("not contain ListView in layout");
		}
	}
...
//    }
    ...
    private void ensureList() {
        ...
        setContentView(thahn.java.agui.R.layout.list_content_simple);
    }
