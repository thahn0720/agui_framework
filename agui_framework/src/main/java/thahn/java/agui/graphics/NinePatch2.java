...
import thahn.java.agui.utils.GraphicsUtilities;


/**
 * Represents a 9-Patch bitmap.
 */
public class NinePatch2 {
     ...
     * <code>null</code>.
     * @return a {@link NinePatch2} or <code>null</code>.
     * @throws IOException
     */
    public static NinePatch2 load(URL fileUrl, boolean convert) throws IOException {
        ...
        return new NinePatch2(fileUrl, image);
    }
    ...
    private NinePatch2(URL fileUrl, BufferedImage image) {
        mFileUrl = fileUrl;
        mImage = image;
