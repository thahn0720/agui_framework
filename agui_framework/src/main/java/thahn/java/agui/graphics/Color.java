...
import thahn.java.agui.utils.MathUtils;
...
public class Color {
    ...
    public static int parseColor(String colorString) {
        if (colorString.charAt(0) == '#') {
        	...
        	if(colorString.length() < 7) {
        		...
        		for (int i = 0; i < 9-colorString.length(); i++) {
        			builder.append("0");
				}
        		colorString = builder.append(colorString.substring(1)).toString();
        	}
    ...
    */
    ...
    public static java.awt.Color toAwtColor(int rgba) {
    	return new java.awt.Color(rgba);
    }
