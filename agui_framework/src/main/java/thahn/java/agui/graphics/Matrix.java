    ...
    */
    public boolean equals(Object obj) {
    	...
    	if(obj != null && obj instanceof Matrix) {
    		double[] temp1 = null;
    		double[] temp2 = null;
    		matrix.getMatrix(temp1);
    		((Matrix)obj).matrix.getMatrix(temp2);
    		ret = Arrays.equals(temp1, temp2);
    	}
        return ret;
    }
...
//    }
     ...
     */
    public boolean preConcat(Matrix other) {
    	matrix.preConcatenate(other.matrix);
    	return true;
...
//    }
     ...
     * @return the result of calling rectStaysRect(). <br>
     * 		   However, don't believe this return value.
     */
    public boolean mapRect(RectF dst, RectF src) {
        if (dst == null || src == null) {
            throw new NullPointerException();
        }
        Point p2d = new Point((int)(src.right - src.left), (int)(src.bottom - src.top));
        
        p2d = (Point) matrix.transform(p2d, p2d);
...
//    }
    ...
    */
    public void setValues(float[] values) {
        ...
        matrix = new AffineTransform(values);
    }
