...
// * </p><p><pre><code>
// * void printSamples(MotionEvent2 ev) {
...
// * </p>
// */
//public final class MotionEvent2 extends InputEvent implements Parcelable {
...
//    static private MotionEvent2 gRecyclerTop = null;
//
...
//
//    private MotionEvent2 mNext;
//    private RuntimeException mRecycledLocation;
//    private boolean mRecycled;
//
//    private MotionEvent2(int pointerCount, int sampleCount) {
...
//    }
//
//    static private MotionEvent2 obtain(int pointerCount, int sampleCount) {
//        final MotionEvent2 ev;
...
//                }
//                return new MotionEvent2(pointerCount, sampleCount);
//            }
//            ev = gRecyclerTop;
...
//    
//    /**
//     * Create a new MotionEvent2, filling in all of the basic values that
//     * define the motion.
//     * 
...
//     */
//    static public MotionEvent2 obtain(long downTime, long eventTime,
//            int action, int pointers, int[] pointerIds, PointerCoords[] pointerCoords,
//            int metaState, float xPrecision, float yPrecision, int deviceId,
//            int edgeFlags, int source, int flags) {
//        MotionEvent2 ev = obtain(pointers, 1);
...
//     * MotionEvent2.
//     */
//    static public MotionEvent2 obtain(long downTime, long eventTime, int action,
//            float x, float y, float pressure, float size, int metaState,
//            float xPrecision, float yPrecision, int deviceId, int edgeFlags) {
//        MotionEvent2 ev = obtain(1, 1);
//        ev.mDeviceId = deviceId;
...
//
//    /**
//     * Create a new MotionEvent2, filling in a subset of the basic motion
...
//
//    /**
//     * Create a new MotionEvent2, copying from an existing one.
//     */
//    static public MotionEvent2 obtain(MotionEvent2 o) {
//        MotionEvent2 ev = obtain(o.mNumPointers, o.mNumSamples);
...
//
//    /**
//     * Create a new MotionEvent2, copying from an existing one, but not including
//     * any historical point information.
//     */
//    static public MotionEvent2 obtainNoHistory(MotionEvent2 o) {
//        MotionEvent2 ev = obtain(o.mNumPointers, 1);
//        ev.mDeviceId = o.mDeviceId;
//        ev.mSource = o.mSource;
//        ev.mEdgeFlags = o.mEdgeFlags;
//        ev.mDownTimeNano = o.mDownTimeNano;
...
//
//    /**
//     * Recycle the MotionEvent2, to be re-used by a later caller.  After calling
...
//            //Log.w("MotionEvent2", "Recycling event " + this, mRecycledLocation);
//        } else {
//            if (mRecycled) {
...
//     * MotionEvent2. For touch events, clients can use this to determine if the
...
//        return "MotionEvent2{" + Integer.toHexString(System.identityHashCode(this))
//            + " action=" + mAction + " x=" + getX()
//            + " y=" + getY() + " pressure=" + getPressure() + " size=" + getSize() + "}";
//    }
//
//    public static final Parcelable.Creator<MotionEvent2> CREATOR
//            = new Parcelable.Creator<MotionEvent2>() {
//        public MotionEvent2 createFromParcel(Parcel in) {
//            in.readInt(); // skip token, we already know this is a MotionEvent2
//            return MotionEvent2.createFromParcelBody(in);
//        }
//
//        public MotionEvent2[] newArray(int size) {
//            return new MotionEvent2[size];
//        }
//    };
//
//    /** @hide */
//    public static MotionEvent2 createFromParcelBody(Parcel in) {
//        final int NP = in.readInt();
//        final int NS = in.readInt();
//        final int NI = NP * NS * NUM_SAMPLE_DATA;
//        
//        MotionEvent2 ev = obtain(NP, NS);
//        ev.mNumPointers = NP;
//        ev.mNumSamples = NS;
//        
...
//     * 
//     * Objects of this type can be used to manufacture new {@link MotionEvent2} objects
