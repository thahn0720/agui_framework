...
public class AnimationSet extends Animation {
    ...
    public AnimationSet(Context context, AttributeSet attrs) {
        ...
        setFlag(PROPERTY_SHARE_INTERPOLATOR_MASK,
                attrs.getBoolean(thahn.java.agui.R.attr.AnimationSet_shareInterpolator, true));
        init();
    
        if (attrs.hasValue(thahn.java.agui.R.attr.AnimationSet_duration)) {
            mFlags |= PROPERTY_DURATION_MASK;
        }
        if (attrs.hasValue(thahn.java.agui.R.attr.AnimationSet_fillBefore)) {
            mFlags |= PROPERTY_FILL_BEFORE_MASK;
        }
        if (attrs.hasValue(thahn.java.agui.R.attr.AnimationSet_fillAfter)) {
            mFlags |= PROPERTY_FILL_AFTER_MASK;
        }
        if (attrs.hasValue(thahn.java.agui.R.attr.AnimationSet_repeatMode)) {
            mFlags |= PROPERTY_REPEAT_MODE_MASK;
        }
        if (attrs.hasValue(thahn.java.agui.R.attr.AnimationSet_startOffset)) {
    ...
    public boolean getTransformation(long currentTime, Transformation t) {
        ...
        // is commenting below code correct? 
        // t.clear();
