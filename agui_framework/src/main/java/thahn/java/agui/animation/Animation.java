...
import thahn.java.agui.graphics.RectF;
...
//    private final CloseGuard guard = CloseGuard.get();
    ...
    public Animation(Context context, AttributeSet attrs) {
    	...
    	setDuration((long) attrs.getInt(thahn.java.agui.R.attr.Animation_duration, 0));
    	setStartOffset((long) attrs.getInt(thahn.java.agui.R.attr.Animation_startOffset, 0));

    	setFillEnabled(attrs.getBoolean(thahn.java.agui.R.attr.Animation_fillEnabled, mFillEnabled));
    	setFillBefore(attrs.getBoolean(thahn.java.agui.R.attr.Animation_fillBefore, mFillBefore));
    	setFillAfter(attrs.getBoolean(thahn.java.agui.R.attr.Animation_fillAfter, mFillAfter));

    	setRepeatCount(attrs.getInt(thahn.java.agui.R.attr.Animation_repeatCount, mRepeatCount));
    	setRepeatMode(attrs.getInt(thahn.java.agui.R.attr.Animation_repeatMode, RESTART));

    	setZAdjustment(attrs.getInt(thahn.java.agui.R.attr.Animation_zAdjustment, ZORDER_NORMAL));

    	setBackgroundColor(attrs.getInt(thahn.java.agui.R.attr.Animation_background, 0));

    	setDetachWallpaper(attrs.getBoolean(thahn.java.agui.R.attr.Animation_detachWallpaper, false));

    	final int resId = attrs.getAnimationId(thahn.java.agui.R.attr.Animation_interpolator, -1);
...
//        }
    ...
    protected static class Description {
        ...
        static Description toDescription(String value) {
        	// % 
        	// and
//        	RELATIVE_TO_SELF
//        	RELATIVE_TO_PARENT
//        	ABSOLUTE
        	...
        	if(value.contains("%p")) { // RELATIVE  
        		des.type = RELATIVE_TO_PARENT;
        		des.value = Float.parseFloat(value.replace("%p", "")) / 100;
        	} else if(value.contains("%")) {
        		des.type = RELATIVE_TO_SELF;
        		des.value = Float.parseFloat(value.replace("%", "")) / 100;
        	} else { // ABSOLUTE
        		des.type = ABSOLUTE;
        		des.value = Float.parseFloat(value);
        	}
        	return des;
        }
    }
