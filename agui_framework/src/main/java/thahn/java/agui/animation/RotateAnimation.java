...
public class RotateAnimation extends Animation {
    ...
    public RotateAnimation(Context context, AttributeSet attrs) {
        ...
        mFromDegrees = attrs.getFloat(thahn.java.agui.R.attr.RotateAnimation_fromDegrees, 0.0f);
        mToDegrees = attrs.getFloat(thahn.java.agui.R.attr.RotateAnimation_toDegrees, 0.0f);
        
        Description d = Description.toDescription(attrs.getString(thahn.java.agui.R.attr.RotateAnimation_pivotX, "0"));
        mPivotXType = d.type;
        mPivotXValue = d.value;
        d = Description.toDescription(attrs.getString(thahn.java.agui.R.attr.RotateAnimation_pivotY, "0"));
        mPivotYType = d.type;
